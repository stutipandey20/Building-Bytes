...
<body>
    ...
    <div class="login">
        <div class="innerlogin" align="center">
            <div class="form" >
            <form action="CProfileServlet" method="post">
                      <div>
                        <input placeholder="Email" id="rec_email" name="txtemail" type="text"  class="input-field">
                    </div>
                    <div>
                        <input placeholder="Secondary Email" id="rec_email" name="txtSemail" type="text"  class="input-field">
                    </div>
                    <div>
                        <input placeholder="Phone Number" id="mobile" name="txtPhone" type="text"  class="input-field">
                    </div>
                    <div>
                        <input placeholder="Description" id="XIIper" name="txtDes" type="text"  class="input-field">
                    </div>
                    <div>
                        <input placeholder="Primary Address" id="Xthper" name="txtPAdd" type="text"  class="input-field">
                    </div>
                    <div>
                        <input placeholder="Secondary Address" id="university" name="txtSAdd" type="text"  class="input-field">
                    </div>
                    <div>
                        <input placeholder="Headquarter" id="university" name="txtHead" type="text"  class="input-field">
                    </div>
                    <div>
                        <input placeholder="Company Size" id="university" name="txtComSize" type="text"  class="input-field">
                    </div>
...
<div class="mySlides fade">
  ...
  <img src="images/s2.JPG" style="width:500px">
</div>
...
<div class="mySlides fade">
  <div class="numbertext"></div>
  <img src="images/s1.JPG" style="width:500px">
</div>
            
<div class="mySlides fade">
  <div class="numbertext"></div>
  <img src="images/s5.JPG" style="width:500px">
</div>
