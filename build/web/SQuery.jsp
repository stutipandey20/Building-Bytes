...
<div class="post">
    <form action="SQueryServlet" method="post">
    <textarea placeholder="Name Please" name="txt0" class="txta1"></textarea><br>
    <textarea placeholder="Topic" name="txt1" class="txta1"></textarea><br>
    <textarea placeholder="Ask your Query" name="txt2" class="txta2"></textarea><br>
...
%>
 <div class="box">
    <div class="icon"><%=resultSet.getString("Topic") %></div>
    <div class="arti_block">
<h2><%=resultSet.getString("Name") %> has asked:</h2>
<p><%=resultSet.getString("Query") %></p>
    </div>
