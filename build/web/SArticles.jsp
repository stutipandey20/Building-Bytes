			...
			<a href="SAccount.jsp" class="btn btn4">My account</a>
             ...
             <div>
               <h4><font face="Palantino Linotype" color="white" size="5px">
                    ...
                    out.println("Hey "+  l+"! would you like to share something?");
                    %>
                    </font></h4>
            </div>
			<div>
...
<div class="post">
    <form action="SArticlesServ" method="post">
    <textarea placeholder="Article Heading" name="txt1" class="txta1"></textarea><br>
    <textarea placeholder="Post Your Article" name="txt2" class="txta2"></textarea><br>
...
String sql ="select *from s_article";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
 <div class="box">
...
<h2><%=resultSet.getString("Article_Head") %></h2>
<p><%=resultSet.getString("Article") %></p>
    </div>
    </div>      
            <%
}
...
@keyframes slider{
      5% { background-image: url(images/pic5.png); 
	        background-size:100% 100%;
	  }
    15%{background-image: url(images/pic6.png);
	        background-size:100% 100%;
	  }
    35%{background-image: url(images/pic7.jpg);
	        background-size:100% 100%;
          }
	50%{background-image: url(images/pic8.jpg); 
	        background-size:100% 100%;
        }
	65%{background-image: url(images/pic9.jpg);
	        background-size:100% 100%;
        }
	85%{background-image: url(images/pic10.jpg);
	        background-size:100% 100%;
        }
	 100%{background-image: url(images/pic11.png);
	        background-size:100% 100%;
         } 	
