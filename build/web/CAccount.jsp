...
<tr class="d1"><td>Primary Email</td><td><%=rs1.getString("Prim_Email") %></td></tr>
<tr class="d1"><td>Password</td><td>***********</td></tr>
<tr class="d1"><td>ISO Number</td><td><%=rs1.getString("ISO_Num") %></td></tr>
<tr class="d1"><td>Employee ID</td><td><%=rs1.getString("Emp_ID") %></td></tr>
...
<tr class="d1"><td>Secondary Email</td><td><%=rs2.getString("Sec_Email") %></td></tr>
<tr class="d1"><td>Contact No</td><td><%=rs2.getString("Phone_No") %></td></tr>
<tr class="d1"><td>Description</td><td><%=rs2.getString("Description") %></td></tr>
<tr class="d1"><td>Primary Address</td><td><%=rs2.getString("Prim_Address") %></td></tr>
<tr class="d1"><td>Secondary Address</td><td><%=rs2.getString("Sec_Address") %></td></tr>
<tr class="d1"><td>Headquarter</td><td><%=rs2.getString("Headquarter") %></td></tr>
<tr class="d1"><td>Company Size</td><td><%=rs2.getString("Company_Size") %></td></tr>
</table>
</div>      
            <%
}
...
%>
               ...
               <div>
                   <br><br>  <a href="CEdit.jsp" target="_blank" class="mybtn">EDIT PROFILE</a>  <a href="CSetNewPass.jsp" target="_blank" class="mybtn">CHANGE PASSWORD</a>
               </div>
               <style>
                   .mybtn
                   {
