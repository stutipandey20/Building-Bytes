...
%>
<form method="post" action="SNewUp">
<div class="data">
<table class="t1">
    <tr class="d1"><td >Name</td><td><textarea class="d11" name="Name"><%=rs1.getString("Name") %></textarea></td></tr>
<tr class="d1"><td>Email</td><td><textarea class="d11" name="email"><%=rs1.getString("Email") %></textarea></td></tr>
            <%
}
while(rs2.next()){
...
%>
<tr class="d1"><td>Recovery Email</td><td><textarea class="d11" name="remail"><%=rs2.getString("Rec_Email") %></textarea></td></tr>
<tr class="d1"><td>Contact No</td><td><textarea class="d11" name="cont"><%=rs2.getString("Phone_No") %></textarea></td></tr>
<tr class="d1"><td>XIIth %</td><td><textarea class="d11" name="twe"><%=rs2.getString("XIIth_Per") %></textarea></td></tr>
<tr class="d1"><td>Xth %</td><td><textarea class="d11" name="ten"><%=rs2.getString("Xth_Per") %></textarea></td></tr>
<tr class="d1"><td>University</td><td><textarea class="d11" name="univ"><%=rs2.getString("University") %></textarea></td></tr>
<tr class="d1"><td>Course</td><td><textarea class="d11"name="cour"><%=rs2.getString("Course") %></textarea></td></tr>
<tr class="d1"><td>Year</td><td><textarea class="d11" name="yr"><%=rs2.getString("Year") %></textarea></td></tr>
<tr class="d1"><td>Skill</td><td><textarea class="d11" name="skill"><%=rs2.getString("Skill") %></textarea></td></tr>
<tr class="d1"><td>Project</td><td><textarea class="d11" name="pro"><%=rs2.getString("Project") %></textarea></td></tr>
</table>
</div>   
