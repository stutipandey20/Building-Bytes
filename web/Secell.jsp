...
<div class="post">
    <form action="SecellServlet" method="post">
         <textarea placeholder="Your name please" name="txt0" class="txta1"></textarea><br>
          <textarea placeholder="Your email please" name="txta" class="txta1"></textarea><br>
    <textarea placeholder="Topic" name="txt1" class="txta1"></textarea><br>
    <textarea placeholder="Post your idea" name="txt2" class="txta2"></textarea><br>
...
<div class="onlyarti">
  ...
  <%
            try{
String ik = session.getAttribute("idd").toString();
...
<h2><%=resultSet.getString("Heading") %></h2>
<p><%=resultSet.getString("Idea") %></p>
    </div>
    </div>      
            <%
}
