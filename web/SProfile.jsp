...
<body>
    ...
    <div class="login">
        <div class="innerlogin" align="center">
            <div class="form" >
            <form action="SProfileServlet" method="post">
               <div>
                        <input placeholder="Email" id="rec_email" name="txtemail" type="text" class="input-field">
                    </div>
                    <div>
                        <input placeholder="Recovery Email" id="rec_email" name="txtRemail" type="text" class="input-field">
                    </div>
                    <div>
                        <input placeholder="Phone Number" id="mobile" name="txtPhone" type="text" class="input-field"">
                    </div>
                    <div>
                        <input placeholder="XIIth_Per" id="XIIper" name="txtXII" type="text" class="input-field">
                    </div>
                    <div>
                        <input placeholder="Xth_Per" id="Xthper" name="txtX" type="text" class="input-field">
                    </div>
                    <div>
                        <input placeholder="University" id="university" name="txtUniversity" type="text" class="input-field">
                    </div>
                    <div>
                        <input placeholder="Course" id="course" name="Course" type="text" class="input-field">
                    </div>
                <div class="select">
                                    <select name="ddYear">
                ...
                <div>
                        <input placeholder="Skills" id="Xthper" name="txtSkill" type="text" class="input-field">
                    </div>
                    <div>
                        <input placeholder="Project" id="Xthper" name="txtProject" type="text" class="input-field">
                    </div>
                    
                    <div>
                        <button type="submit" class="button2">SUBMIT</button></div>
